                    ...
                    authUser ?
                        <div className='join'>
                            ...
                            <div className=" dropdown dropdown-hover">
                                <button className="btn btn-sm py-1 rounded-e-md h-auto   join-item  bg-blue-600 hover:bg-blue-700 text-white">
                                ...
                                <ul className="menu dropdown-content rounded z-[1] p-2 shadow bg-white text-black">
                                    <li>
